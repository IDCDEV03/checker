    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card border-primary mb-3">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('company_inserttruck',['ts'=>request()->id])}}" >
                        @csrf
 @foreach ($transport_company as $item)
                       
        <div class="col-md-10 mb-3">
          <span class="text-dark fs-5">บริษัทขนส่ง : {{$item->ts_name}} </span>
        </div>                          

    
        <input type="hidden" name="transport_id" value="{{request()->id}}">
